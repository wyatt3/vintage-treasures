...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'failed_jobs', 'translations', 'user_roles', 'permissions', 'roles', 'settings'],
        ],
