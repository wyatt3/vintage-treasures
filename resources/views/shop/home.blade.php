...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6 col-xl-4">
            <div class="card mb-3 bg-primary text-white" style="height: 410px; ">
                ...
                <div class="card-img bg-dark" style="height:275px"><img class="rounded" style="height:100%; object-fit:scale-down;" src="{{ asset('storage/'. $product->imageName) }}" width="100%"></div>
                </a>
